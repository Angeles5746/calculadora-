...
# Fila 1: Funciones de memoria y limpieza
    crear_boton(ventana, "MC", 1, 0, memoria_limpiar, "#1d50e8", "white")
    crear_boton(ventana, "MR", 1, 1, memoria_recuperar, "#165eee", "white")
    crear_boton(ventana, "M+", 1, 2, memoria_sumar, "#1928cd", "white")
    crear_boton(ventana, "M-", 1, 3, memoria_restar, "#3265f3", "white")
    crear_boton(ventana, "C", 1, 4, limpiar, "#a8179e", "white")
    crear_boton(ventana, "←", 1, 5, borrar, "#d01aa9", "white")

    # Fila 2: Funciones científicas superiores
    crear_boton(ventana, "sin", 2, 0, seno, "#9917b0", "white")
    crear_boton(ventana, "cos", 2, 1, coseno, "#8724a6", "white")
    crear_boton(ventana, "tan", 2, 2, tangente, "#3498db", "white")
    crear_boton(ventana, "log", 2, 3, logaritmo, "#000000", "white")
    crear_boton(ventana, "ln", 2, 4, logaritmo_natural, "#000000", "white")
    crear_boton(ventana, "(", 2, 5, lambda: escribir("("), "#95a5a6", "white")

    # Fila 3: Más funciones científicas
    crear_boton(ventana, "√", 3, 0, raiz_cuadrada, "#000000", "white")
    crear_boton(ventana, "x²", 3, 1, lambda: escribir("**2"), "#000000", "white")
    crear_boton(ventana, "xʸ", 3, 2, potencia, "#000000", "white")
    crear_boton(ventana, "x!", 3, 3, factorial, "#000000", "white")
    crear_boton(ventana, "%", 3, 4, porcentaje, "#000000", "white")  # <-- Paréntesis corregido
    ...
    ventana.mainloop()
    # Elimina las siguientes líneas para evitar errores al cerrar la ventana:
    # ventana.destroy()
